...
export default function Home() {
  return (
    <main className="pt-16">
      ...
      <section className="border-t border-cream-100/10 bg-charcoal-900">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 py-20">
          <div className="max-w-2xl">
            <p className="text-tan-500 text-xs uppercase tracking-[0.2em] font-semibold mb-4">Here's the truth</p>
            <h2 className="text-2xl sm:text-3xl font-bold mb-6 tracking-tight leading-snug text-cream-100">
              Most people are either overpaying for life insurance or haven't found affordable options. Either way, they're losing.
            </h2>
            <div className="space-y-4 text-cream-100/60 leading-relaxed">
              <p>
      ...
      <section className="border-t border-cream-100/10 bg-charcoal-950">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 py-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-cream-100/10">
            <div className="bg-charcoal-950 p-8">
              <div className="text-tan-500 text-4xl font-bold mb-4">01</div>
              <h3 className="text-cream-100 font-semibold text-lg mb-2">We talk</h3>
            ...
            <div className="bg-charcoal-950 p-8">
              <div className="text-tan-500 text-4xl font-bold mb-4">02</div>
              <h3 className="text-cream-100 font-semibold text-lg mb-2">I do the work</h3>
              <p className="text-cream-100/50 text-sm leading-relaxed">
            ...
            <div className="bg-charcoal-950 p-8">
              <div className="text-tan-500 text-4xl font-bold mb-4">03</div>
              <h3 className="text-cream-100 font-semibold text-lg mb-2">You decide</h3>
              <p className="text-cream-100/50 text-sm leading-relaxed">
      ...
      <section className="border-t border-cream-100/10 bg-charcoal-900">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <p className="text-tan-500 text-xs uppercase tracking-[0.2em] font-semibold mb-4">Good fit if</p>
              <h2 className="text-2xl sm:text-3xl font-bold mb-8 tracking-tight text-cream-100">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item} className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-tan-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-charcoal-950 border border-cream-100/10 p-8">
              <p className="text-tan-500 text-xs uppercase tracking-[0.2em] font-semibold mb-6">Why Spencer</p>
              <div className="space-y-6">
                <div>
                  <h4 className="text-cream-100 font-semibold text-sm mb-1">Independent — not captive</h4>
                  <p className="text-cream-100/50 text-sm leading-relaxed">
                ...
                <div className="border-t border-cream-100/10 pt-6">
                  <h4 className="text-cream-100 font-semibold text-sm mb-1">Backed by Solace Financial</h4>
                  <p className="text-cream-100/50 text-sm leading-relaxed">
                    Deep carrier relationships. Decades of combined experience. The infrastructure to get it done right.
                  </p>
                </div>
                <div className="border-t border-cream-100/10 pt-6">
                  <h4 className="text-cream-100 font-semibold text-sm mb-1">All 50 states</h4>
                  <p className="text-cream-100/50 text-sm leading-relaxed">
